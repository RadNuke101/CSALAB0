...
public class Receipt {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%6d%4s%42.2f%,20.2f%n", qtyCDP, CDP, UP_CDP, tpCDP); // CD Players
		System.out.printf("%6d%4s%38.2f%,20.2f%n", qtyTR, TR, UP_TR, tpTR); // Tape Recorders
		...
		System.out.printf("%43s%20.2f%n", "TAX @ 8.25%", tax);
		...
		System.out.printf("%43s%20.2f%n", "TOTAL", total);
